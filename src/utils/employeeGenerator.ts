...
export const initialConfig: GeneratorConfig = {
  ...
  count: 100,
  roles: [
    { id: 'sales', title: 'Sales Representative', department: 'Sales', ou: '', groups: 'GG_Sales', gpos: 'GPO_Baseline\nGPO_Sales' },
    { id: 'finance', title: 'Accountant', department: 'Finance', ou: '', groups: 'GG_Finance', gpos: 'GPO_Baseline\nGPO_Finance' },
    { id: 'support', title: 'Support Specialist', department: 'IT', ou: '', groups: 'GG_IT', gpos: 'GPO_Baseline\nGPO_IT' },
  ],
